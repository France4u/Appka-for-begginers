            ...
            if event2 == "Ok" :
                ...
                if i < players :
                    ...
                    if players == 2 :
                        ...
                        vysledek1 = '{0} '.format(kdy_a[0:-1]) + '{0} '.format(kde_d[0:-1])+ '{0} '.format(kdo_c[0:-1])+ (s_kým_b[0:-1])+ '{0} '.format(dělali_a[0:-1])+ '{0} '.format(co_a[0:-1])
                        vysledek2 = '{0} '.format(kdy_b[0:-1]) + '{0} '.format(kde_a[0:-1])+ '{0} '.format(kdo_d[0:-1])+ (s_kým_c[0:-1])+ '{0} '.format(dělali_c[0:-1])+ '{0} '.format(co_d[0:-1])
                        vysledek3 = '{0} '.format(kdy_c[0:-1]) + '{0} '.format(kde_b[0:-1])+ '{0} '.format(kdo_a[0:-1])+ (s_kým_d[0:-1])+ '{0} '.format(dělali_b[0:-1])+ '{0} '.format(co_b[0:-1])
                        vysledek4 = '{0} '.format(kdy_d[0:-1]) + '{0} '.format(kde_c[0:-1])+ '{0} '.format(kdo_b[0:-1])+ (s_kým_a[0:-1])+ '{0} '.format(dělali_d[0:-1])+ '{0} '.format(co_c[0:-1])
